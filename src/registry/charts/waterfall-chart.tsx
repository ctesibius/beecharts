...
function WaterfallChartCanvas<TData extends Record<string, unknown>>({
  ...
  const { option, colorEpoch } = useCompiledOption(compileWaterfallOption, { data, externalBrush });
        ...
        footer={
          showBrush && !isLoading ? (
            <BeeChartBrush
              ...
              rootFields={{ nameKey, valueKey, externalBrush: true }}
              xDataKey={nameKey}
...
export function Bars(_: { isClickable?: boolean } = {}) {
  return null;
}

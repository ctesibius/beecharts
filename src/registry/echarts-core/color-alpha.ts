...
/** Soft top-to-bottom fill for area series (matches evilcharts vertical fade). */
...
/** Matches evilcharts `DEFAULT_FILL_OPACITY` on filled radars. */
...
/** Radial fill for radar polygons — per-shape bbox (evilcharts FillGradient). */

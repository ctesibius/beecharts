...
links:
  github: https://github.com/legions-developer/becocharts/blob/main/src/registry/charts/pie-chart.tsx
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@beecharts/pie-chart"]} />
  </TabsPanel>
    ...
    <Steps>
      ...
      <Step>
        ...
        <StepContent>
          <ComponentSource
            name="pie-chart"
            title="components/beecharts/charts/pie-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
...
import {
  ...
  Legend,
  Background,
} from "@/components/beecharts/charts/pie-chart";
```
...
```tsx
<BeePieChart data={data} dataKey="visitors" nameKey="browser" config={chartConfig}>
  <Legend isClickable />
  <Tooltip />
...
<ApiHeading>BeePieChart</ApiHeading>

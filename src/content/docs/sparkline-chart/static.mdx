...
links:
  github: https://github.com/legions-developer/becocharts/blob/main/src/registry/charts/sparkline-chart.tsx
  doc: https://recharts.github.io/en-US/examples/TinyLineChart/
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@evilcharts/sparkline-chart"]} />
  </TabsPanel>
      ...
      <Step>
        ...
        <StepContent>
          <ComponentSource
            ...
            title="components/beecharts/charts/sparkline-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
       ...
       <Step>
        ...
        <StepDescription>
          Create `dot.tsx` inside the `evilcharts/ui` folder and paste the code there.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="dot"
        ...
        <StepDescription>
          For background patterns, create `background.tsx` in `evilcharts/ui` as well.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="background"
            title="components/beecharts/ui/background.tsx"
          />
        </StepContent>
      </Step>
    </Steps>
...
<ApiHeading>BeeSparklineChart</ApiHeading>
...
<ApiTable>
  <ApiRow name="variant" type="DotVariant">
    Dot style forwarded to `@evilcharts/dot`.
  </ApiRow>
</ApiTable>

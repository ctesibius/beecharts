...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@beecharts/sparkline-chart"]} />
  </TabsPanel>
    ...
    <Steps>
      ...
      <Step>
       ...
       <Step>
        ...
        <StepDescription>
          Create `dot.tsx` inside the `beecharts/ui` folder and paste the code there.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="dot"
        ...
        <StepDescription>
          For background patterns, create `background.tsx` in `beecharts/ui` as well.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="background"

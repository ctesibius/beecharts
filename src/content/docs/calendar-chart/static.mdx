...
links:
  github: https://github.com/legions-developer/becocharts/blob/main/src/registry/charts/calendar-chart.tsx
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@beecharts/calendar-chart", "@beecharts/chart-recipes"]} />
  </TabsPanel>
    ...
    <Steps>
      ...
      <Step>
        ...
        <StepContent>
          <ComponentSource
            name="calendar-chart"
            title="components/beecharts/charts/calendar-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
       ...
       <Step>
        ...
        <StepDescription>
          Copy `chart-recipes.ts` into your project (or install `@beecharts/chart-recipes`) so you can map daily capacity and assignments with `prepareCalendarWorkloadCells()`.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="chart-recipes"
...
| View | Chart | Best for |
|------|-------|----------|
| One person, one month | `BeeCalendarChart` | Spot overload days, PTO gaps, sprint rhythm |
| Team × week | `BeeHeatmapChart` + `prepareTeamWorkloadMatrix()` | Compare who is over/under capacity across the same days |
| Team × month (dense) | `BeeHeatmapChart` | Portfolio view when calendar tiles are too small |
...
<ApiHeading>BeeCalendarChart</ApiHeading>

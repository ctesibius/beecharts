...
description: Bridges, deltas, and totals stacked as one composable BeeChart
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@beecharts/waterfall-chart"]} />
  </TabsPanel>
...
<ApiTable>
  ...
  <ApiRow name="align" type='"left" | "center" | "right"' default='"right"'>
    Horizontal alignment (Bee waterfall defaults tighter to chart gutter).
  </ApiRow>

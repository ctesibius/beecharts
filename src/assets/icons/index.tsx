...
export function CalendarChartIcon({
  ...
  const cells = [
    ...
    { x: 3.75, y: 4.5, opacity: 0.35 },
    { x: 6.25, y: 4.5, opacity: 0.5 },
    { x: 8.75, y: 4.5, opacity: 0.3 },
    { x: 11.25, y: 4.5, opacity: 0.65 },
    { x: 13.75, y: 4.5, opacity: 0.4 },
    { x: 16.25, y: 4.5, opacity: 0.25 },
    { x: 1.25, y: 7, opacity: 0.45 },
    { x: 3.75, y: 7, opacity: 0.8 },
    { x: 6.25, y: 7, opacity: 0.95 },
    { x: 8.75, y: 7, opacity: 0.55 },
    { x: 11.25, y: 7, opacity: 0.42 },
    { x: 13.75, y: 7, opacity: 0.28 },
    { x: 16.25, y: 7, opacity: 0.18 },
  ] as const;
  ...
  return (
    ...
    >
      <g fill={fill}>
        <rect x="1" y="1.5" width="16" height="2.25" rx="0.5" fill={secondaryfill} fillOpacity="0.35" />
        {cells.map((cell) => (
          <rect
            key={`${cell.x}-${cell.y}`}
            x={cell.x}
            ...
            height="1.75"
            rx="0.35"
            fill={cell.opacity >= 0.8 ? fill : secondaryfill}
...
export function HeatmapChartIcon({
  ...
  const cells = [
    ...
    { x: 6.25, y: 1.5, opacity: 0.4 },
    { x: 11, y: 1.5, opacity: 0.55 },
    { x: 1.5, y: 6.25, opacity: 0.35 },
    { x: 6.25, y: 6.25, opacity: 0.75 },
    { x: 11, y: 6.25, opacity: 0.5 },
    { x: 1.5, y: 11, opacity: 0.45 },
    { x: 6.25, y: 11, opacity: 0.85 },
    { x: 11, y: 11, opacity: 1 },
  ] as const;
      ...
      <g fill={fill}>
        {cells.map((cell) => (
          <rect
            ...
            height="4.25"
            rx="0.75"
            fill={cell.opacity >= 0.85 ? fill : secondaryfill}
            fillOpacity={cell.opacity}
          />
        ))}
      </g>
...
export function SparklineChartIcon({
  ...
  return (
    ...
    >
      <path
        d="M2 11.5L5 9L8 10.5L11 7L14 8.5L16 6.5"
      ...
      />
      <path
        d="M2 10L5 7.5L8 9L11 5.5L14 7L16 4.5"
        stroke={fill}
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
        fill="none"
      />
      <circle cx="16" cy="4.5" r="1.25" fill={fill} />
    </svg>
  );
}

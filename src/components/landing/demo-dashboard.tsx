      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
          <ChartCard
            ...
            description="New and expansion against churned MRR"
            bodyHeight="h-72"
            className="lg:col-span-2"
          >
            <BeeComposedChart
              data={MOVEMENT_MONTHLY}
            ...
            >
              <ComposedGrid />
              <ComposedXAxis dataKey="month" tickFormatter={formatMonthTickShort} />
              <ComposedLegend />
              <ComposedTooltip />
              <Bar dataKey="new" />
              <Line dataKey="churned" curveType="monotone" />
            </BeeComposedChart>
          </ChartCard>

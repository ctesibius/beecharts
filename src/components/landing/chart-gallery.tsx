    ...
    <section className="w-full">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        {CHARTS.map(({ name, slug, Preview }) => (
          ...
          >
            <div className="bg-muted/30 text-foreground/70 group-hover:text-foreground flex aspect-[16/10] items-center justify-center overflow-hidden p-4 transition-colors">
              <Preview />
            </div>

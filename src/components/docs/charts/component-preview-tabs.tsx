          ...
          <div className="flex flex-row items-center justify-between px-2">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="text-muted-foreground hover:text-foreground flex size-11 min-h-11 min-w-11 shrink-0 cursor-pointer items-center justify-center rounded-md opacity-0 transition-all duration-200 ease-out group-hover:opacity-100 focus-visible:opacity-100"
              >
                <RotateCw
